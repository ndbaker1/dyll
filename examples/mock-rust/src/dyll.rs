// generated by /app/target/release/dyll --output-path /app/tests/../examples/mock-rust/src/dyll.rs header /app/tests/../examples/program/test_lib.h
...
pub unsafe extern "C" fn add(
    ...
    let add: extern "C" fn(
        a: ::core::ffi::c_int,
        b: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int = unsafe { std::mem::transmute(get_sym("add")) };
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn add_and_double(
    a: ::core::ffi::c_int,
    b: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    ...
    let _enter = span.enter();
    tracing::trace!("@entry");
    let add_and_double: extern "C" fn(
        a: ::core::ffi::c_int,
        b: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int = unsafe { std::mem::transmute(get_sym("add_and_double")) };
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn set_five(ptr: *mut ::core::ffi::c_int) -> () {
    let span = tracing::span!(tracing::Level::TRACE, stringify!(set_five));
    let _enter = span.enter();
    tracing::trace!("@entry");
    let set_five: extern "C" fn(ptr: *mut ::core::ffi::c_int) -> () = unsafe {
