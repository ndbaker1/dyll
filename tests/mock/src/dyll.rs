...
// generated by /usr/src/myapp/target/release/dyll --output-dir mock/src --lib-path libtest.so header test_lib.h#[allow(unused)]
mod print_hello {
    use super::*;
...
pub unsafe extern "C" fn print_hello() -> () {
    tracing::trace!(concat!("[CALL] ", stringify!(print_hello)));
...
pub unsafe extern "C" fn add(a: c_int, b: c_int) -> c_int {
    tracing::trace!(concat!("[CALL] ", stringify!(add)));
...
pub unsafe extern "C" fn add_and_double(a: c_int, b: c_int) -> c_int {
    tracing::trace!(concat!("[CALL] ", stringify!(add_and_double)));
...
pub unsafe extern "C" fn set_five(ptr: *mut c_int) -> () {
    tracing::trace!(concat!("[CALL] ", stringify!(set_five)));
